...
const GoogleGIcon = ({ className = "" }: { className?: string }) => (
  // Multicolor Google “G” icon (24x24)
  <svg
    className={className}
    viewBox="0 0 24 24"
    width="24"
...
const Reviews = () => {
  ...
  // New Google reviews you provided
  ...
  // Merge existing site testimonials with the new ones
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((t, idx) => (
              <FadeIn key={`${t.name}-${idx}`} delay={idx * 0.05}>
                <div className="border-l border-cream/15 pl-6">
                  ...
                  <p className="hm-display whitespace-pre-line text-xl leading-[1.15] text-cream md:text-2xl md:leading-[1.05]">
                    “{t.quote}”
                  </p>
