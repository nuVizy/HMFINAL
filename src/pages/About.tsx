...
const About = () => {
  ...
  const seoImage = gallery[2] ?? gallery[0] ?? heroImage;
  const heroVisual = gallery[7] ?? gallery[1] ?? heroImage;
  ...
  return (
    <div>
      <Seo
        ...
        description="Meet the team behind Hungry Monkey and the standards that shape every Cyprus wedding, villa dinner and event."
        image={seoImage}
        canonicalPath="/about"
      />
            ...
            <div className="lg:col-span-6">
              <FadeIn>
                ...
                <div className="mt-7 space-y-4 text-sm leading-relaxed text-ink/70 md:text-base">
                  ...
                  <p>
                    We intricately manage every facet of their experience and take joy in extending a
          ...
          <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
            ...
            <FadeIn className="lg:col-span-7">
              <div className="grid grid-cols-12 gap-4">
                {credibilityImages.map((src, i) => (
                  <div
                    key={`${src}-${i}`}
                    className={
                      i === 0
                        ? "col-span-12 overflow-hidden bg-ink md:col-span-6"
                        : "col-span-6 overflow-hidden bg-ink md:col-span-3"
                    }
                  >
                    <img
                      src={src}
